...
class TipeKontak extends Render_Controller
{
    ...
    {
        // Page Settings
        $this->title = 'Data Master - Tipe Kontak';
    ...
    public function export_excel()
    {
        ...
        $col_start = "A";
        $col_end = "E";
        $title_excel = "AuditAny_Data_Master_Tipe_Kontak";
        // Header excel ================================================================================================
        ...
        $sheet->mergeCells($col_start . $row . ":" . $col_end . $row)
            ->setCellValue("A$row", "List Tipe Kontak");
    ...
    {
        // title name
        $title_name = "List Tipe Kontak";

        // document name
        $doc_name = "AuditAny_Data_Master_Tipe_Kontak";
