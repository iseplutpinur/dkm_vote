...
class Resiko extends Render_Controller
{
    ...
    public function downloadSample()
    {
        ...
        $col_start = "A";
        $col_end = "D";
        $title_excel = "AuditAny_Data_Master_Resiko_Sample";
        // Header excel ================================================================================================
        ...
        $sheet->mergeCells($col_start . $row . ":" . $col_end . $row)
            ->setCellValue("A$row", "List Resiko");
    ...
    public function export_excel()
    {
        ...
        $col_start = "A";
        $col_end = "D";
        $title_excel = "AuditAny_Data_Master_Resiko";
        // Header excel ================================================================================================
        $spreadsheet = new PhpOffice\PhpSpreadsheet\Spreadsheet();
        $sheet = $spreadsheet->getActiveSheet();
    ...
    {
        // title name
        $title_name = "List Resiko";

        // document name
        $doc_name = "AuditAny_Data_Master_Resiko";
