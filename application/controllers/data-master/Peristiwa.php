...
class peristiwa extends Render_Controller
{
    ...
    {
        // Page Settings
        $this->title = 'Data Master - Data Formal';
    ...
    public function export_excel()
    {
        ...
        $col_start = "A";
        $col_end = "E";
        $title_excel = "AuditAny_Data_Master_Peristiwa";
        // Header excel ================================================================================================
        ...
        $sheet->mergeCells($col_start . $row . ":" . $col_end . $row)
            ->setCellValue("A$row", "List Peristiwa");
    ...
    {
        // title name
        $title_name = "List Peristiwa";

        // document name
        $doc_name = "AuditAny_Data_Master_Peristiwa";
    ...
    public function insert()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $result = $this->model->insert($name, $details, $status);
    ...
    public function update()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $details = $this->input->post('details');
            $status = $this->input->post('status');
            $result = $this->model->update($id, $name, $details, $status);
