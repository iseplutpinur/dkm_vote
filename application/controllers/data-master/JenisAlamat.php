...
class JenisAlamat extends Render_Controller
{
    ...
    {
        // Page Settings
        $this->title = 'Data Master - Jenis Alamat';
    ...
    public function export_excel()
    {
        ...
        $col_start = "A";
        $col_end = "E";
        $title_excel = "AuditAny_Data_Master_Jenis_Alamat";
        // Header excel ================================================================================================
        ...
        $sheet->mergeCells($col_start . $row . ":" . $col_end . $row)
            ->setCellValue("A$row", "List Jenis Alamat");
    ...
    {
        // title name
        $title_name = "List Jenis Alamat";

        // document name
        $doc_name = "AuditAny_Data_Master_Jenis_Alamat";
