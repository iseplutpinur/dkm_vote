...
class Membership extends Render_Controller
{
    ...
    {
        // Page Settings
        $this->title = 'Data Master - Membership';
    ...
    public function export_excel()
    {
        ...
        $col_start = "A";
        $col_end = "E";
        $title_excel = "AuditAny_Data_Master_Membership";
        // Header excel ================================================================================================
        ...
        $sheet->mergeCells($col_start . $row . ":" . $col_end . $row)
            ->setCellValue("A$row", "List Membership");
    ...
    {
        // title name
        $title_name = "List Membership";

        // document name
        $doc_name = "AuditAny_Data_Master_Membership";
