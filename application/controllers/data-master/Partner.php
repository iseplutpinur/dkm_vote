...
class Partner extends Render_Controller
{
    ...
    {
        // Page Settings
        $this->title = 'Data Master - Partner';
    ...
    public function export_excel()
    {
        ...
        $col_start = "A";
        $col_end = "G";
        $title_excel = "AuditAny_Data_Master_Partner";
        // Header excel ================================================================================================
        ...
        $sheet->mergeCells($col_start . $row . ":" . $col_end . $row)
            ->setCellValue("A$row", "List Partner");
    ...
    {
        // title name
        $title_name = "List Partner";

        // document name
        $doc_name = "AuditAny_Data_Master_Partner";
    ...
    public function downloadSample()
    {
        ...
        $col_start = "A";
        $col_end = "G";
        $title_excel = "AuditAny_Data_Master_Partner_Sample";
        // Header excel ================================================================================================
        $spreadsheet = new PhpOffice\PhpSpreadsheet\Spreadsheet();
        $sheet = $spreadsheet->getActiveSheet();
