...
class Count extends Render_Controller
{
  ...
  {
    // get data
    $data = $this->model->dataCount($id);
    $header = '
        <body style="font-family:Arial">
        <div class="header">
            <center>
                <h3><span style="text-align:center; ">Undangan Countan Ketua Umum DKM Ulilalbab</span></h3>
    ...
    // document name
    $doc_name = "{$data->nama} ({$data->npp})  - Undagan Countan Ketua Umum";
